...
const PrismaTable = ({ namespace, model, initialFilters, updateInitialFilters, redirectToEntityWithFilters }: Props) => (
  <DynamicTable model={model} namespace={namespace} usage="dataPreview"
