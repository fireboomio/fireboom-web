...
const IdeCodeContainer: FC<Props> = (props) => {
    return <div className={`${ideStyles['code-container']} ${props.expandAction ? ideStyles['code-container-expand-action'] : ''} ${props.fullScreen ? ideStyles['code-container-full-screen'] : ''}`}>
        <Editor
        ...
        />
        {/* 是否展开输入和输出区域 */}
        <div className="show-more flex items-center justify-center cursor-pointer" onClick={props.onClickExpandAction}>
