...
import { AlignRightOutlined, CaretDownOutlined, CloseOutlined, DoubleLeftOutlined, LoadingOutlined, ReloadOutlined, UpOutlined } from '@ant-design/icons';
    ...
    return (
        <div className={`${ideStyles['ide-container-depend-list']}`}>
            <div className="title-top flex justify-between items-center">
                ...
                <DoubleLeftOutlined color="#C0C4CE" className="cursor-pointer" onClick={() => {
                    props.onFold();
                }} />
            </div>
            {/* 搜索 */}
            ...
            <div className="list">
                ...
                {[...dependList.entries()].map(([name, version], index) => {
                    return (
                        ...
                        >
                            <div
                                className={`name ${showSelectVersion === index ? 'show-select-version-name' : ''
                                    } truncate`}
                            >
                                {name}
                            </div>
