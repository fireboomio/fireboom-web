 ...
 */
export class GraphiQL extends Component<GraphiQLProps> {
...
const GraphiQLConsumeContexts = forwardRef<GraphiQLWithContext, GraphiQLWithContextProviderProps>(
...
class GraphiQLWithContext extends React.Component<GraphiQLWithContextConsumerProps, GraphiQLState> {
  ...
  render() {
    ...
    //       label="Introspect"
    //     />
    //     {this.props.toolbar?.additionalContent ? this.props.toolbar.additionalContent : null}
    //   </GraphiQL.Toolbar>
    // )
