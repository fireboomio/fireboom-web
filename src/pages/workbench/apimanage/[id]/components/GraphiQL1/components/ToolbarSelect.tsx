...
export class ToolbarSelect extends React.Component<ToolbarSelectProps, ToolbarSelectState> {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <ul className={'toolbar-select-options' + (visible ? ' open' : '')}>{optionChildren}</ul>
      </a>
    )
  }
...
export function ToolbarSelectOption({ onSelect, label, selected }: ToolbarSelectOptionProps) {
  return (
    <li
      onMouseOver={e => {
