...
let imports = {}
const defaults = {}
imports['__wbindgen_placeholder__'] = defaults
let wasm
 ...
 * @returns {string}
 */
defaults.format = function (schema, params) {
  try {
 ...
 * @returns {string}
 */
defaults.get_config = function (params) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16)
 ...
 * @returns {string}
 */
defaults.native_types = function (input) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16)
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
    const len0 = WASM_VECTOR_LEN
 ...
 * @returns {string}
 */
defaults.referential_actions = function (input) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16)
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
    const len0 = WASM_VECTOR_LEN
 ...
 * @returns {string}
 */
defaults.preview_features = function () {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16)
 ...
 * @returns {string}
 */
defaults.text_document_completion = function (schema, params) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16)
    const ptr0 = passStringToWasm0(schema, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
    const len0 = WASM_VECTOR_LEN
 ...
 * @returns {string}
 */
defaults.code_actions = function (schema, params) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16)
    const ptr0 = passStringToWasm0(schema, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
    const len0 = WASM_VECTOR_LEN
...
defaults.AdoNetString = AdoNetString
/**
 * A version of `JdbcString` to be used from web-assembly.
 */
class JdbcString {
...
defaults.JdbcString = JdbcString

defaults.__wbindgen_error_new = function (arg0, arg1) {
  const ret = new Error(getStringFromWasm0(arg0, arg1))
  return addHeapObject(ret)
}

defaults.__wbindgen_string_new = function (arg0, arg1) {
  const ret = getStringFromWasm0(arg0, arg1)
  return addHeapObject(ret)
}

defaults.__wbindgen_throw = function (arg0, arg1) {
